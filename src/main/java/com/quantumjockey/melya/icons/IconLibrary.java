...
public class IconLibrary {
    ...
    private final Image folderIcon = new Image(getClass().getResourceAsStream("/com/quantumjockey/melya/icons/images/empty_folder.png"));
    private final Image groupIcon = new Image(getClass().getResourceAsStream("/com/quantumjockey/melya/icons/images/image_group.png"));
    private final Image rootIcon = new Image(getClass().getResourceAsStream("/com/quantumjockey/melya/icons/images/data_group.png"));
